...
all_lams <- read.csv("ipms/Model_Fits/ipms/lin_mod_general_ipm_site_lambdas_prob_resamp.csv",
...
pdf(file = "ipms/Figures/ipm_output/lambdas_by_clim_prob_resamp.pdf",
    height = 9, width = 9)
for(i in 1:4) {
...
pdf(file = "ipms/Figures/ipm_output/lambdas_by_clim_sans_israel_prob_resamp.pdf",
    height = 9, width = 9)
for(i in 1:4) {

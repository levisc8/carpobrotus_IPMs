...
# flow_mod <- all_flow_mods[[1]][["times_sw2_seas"]]
# recr_mod <- readRDS("ipms/Model_Fits/recr_size_brm.rds")
# 
# data_list <- list(
#   grow_mod       = grow_mod,
#   grow_sigma_int = fixef(grow_mod)["sigma_Intercept", 1],
#   grow_sigma_z   = fixef(grow_mod)["sigma_log_size", 1],
#   surv_mod       = surv_mod,
#   repr_mod       = repr_mod,
#   flow_mod       = flow_mod,
#   recr_mu        = -8.62,
...
# grow_sigma_ints <- ranef(grow_mod)[[1]][ , , "sigma_Intercept"]
# grow_sigma_ints <- setNames(as.list(grow_sigma_ints[ ,1]),
#                             paste0("grow_sigma_int_", 
#                                    dimnames(grow_sigma_ints)[[1]]))


# Data list for deterministic IPMs
# det_data_list <- c(data_list, clim_list, grow_sigma_ints)
...
#     family  = "CC",
#     s_population       = predict(surv_mod, 
#                                  newdata = data.frame(
#                                    log_size = z_1,
#                                    temp_dry_t = rep(temp_dry_t_population,
#                                                     length(z_1)),
#                                    temp_wet_t = rep(temp_wet_t_population,
#                                                     length(z_1)),
#                                    prec_dry_t = rep(prec_dry_t_population,
#                                                     length(z_1)),
#                                    prec_wet_t = rep(prec_wet_t_population,
#                                                     length(z_1)),
#                                    sw2_dry_t  = rep(sw2_dry_t_population,
#                                                     length(z_1)),
#                                    sw2_wet_t  = rep(sw2_wet_t_population,
#                                                     length(z_1)),
#                                    site       = s_char(population),
#                                    native     = is_native(population)
#                                  )),
#     g_mu_population = predict_carp_ipm(grow_mod, 
#                                        data = data.frame(
#                                          log_size     = z_1,
#                                          mean_temp_t  = rep(mean_temp_t_population,
#                                                             length(z_1)),
#                                          seas_sw2_t   = rep(seas_sw2_t_population,
#                                                             length(z_1)),
#                                          seas_sw1_t   = rep(seas_sw1_t_population,
#                                                             length(z_1)), 
#                                          seas_temp_t  = rep(seas_temp_t_population,
#                                                             length(z_1)),
#                                          total_prec_t = rep(total_prec_t_population,
#                                                             length(z_1)),
#                                          mean_sw2_t   = rep(mean_sw2_t_population,
#                                                             length(z_1)),
#                                          mean_sw1_t   = rep(mean_sw1_t_population,
#                                                             length(z_1)),
#                                          seas_prec_t  = rep(seas_prec_t_population,
#                                                             length(z_1)),
#                                          site         = s_char(population)
#                                        )),
#     g_sd_population = exp(grow_sigma_int + grow_sigma_z * z_1 + grow_sigma_int_population),
...
#     family = "CC",
#     p_repr_population = predict_carp_ipm(repr_mod,
#                                          data = data.frame(
#                                            log_size       = z_1,
#                                            mean_temp_t_1  = rep(mean_temp_t_1_population,
#                                                                 length(z_1)),
#                                            seas_sw2_t_1   = rep(seas_sw2_t_1_population,
#                                                                 length(z_1)),
#                                            seas_temp_t_1  = rep(seas_temp_t_1_population,
#                                                                 length(z_1)),
#                                            total_prec_t_1 = rep(total_prec_t_1_population,
#                                                                 length(z_1)),
#                                            mean_sw2_t_1   = rep(mean_sw2_t_1_population,
#                                                                 length(z_1)),
#                                            seas_prec_t_1  = rep(seas_prec_t_1_population,
#                                                                 length(z_1)),
#                                            site       = s_char(population)
#                                          )),
#     n_flow_population = predict_carp_ipm(flow_mod,
#                                          data = data.frame(
#                                            log_size     = z_1,
#                                            temp_dry_t_1 = rep(temp_dry_t_1_population,
#                                                               length(z_1)),
#                                            temp_wet_t_1 = rep(temp_wet_t_1_population,
#                                                               length(z_1)),
#                                            prec_dry_t_1 = rep(prec_dry_t_1_population,
#                                                               length(z_1)),
#                                            prec_wet_t_1 = rep(prec_wet_t_1_population,
#                                                               length(z_1)),
#                                            sw2_dry_t_1  = rep(sw2_dry_t_1_population,
#                                                               length(z_1)),
#                                            sw2_wet_t_1  = rep(sw2_wet_t_1_population,
#                                                               length(z_1)),
#                                            site         = s_char(population),
#                                            native       = is_native(population)
#                                          )),
...
#                         rep("z", 2))
#   ) %>%
#   define_domains(z = c(L_z, U_z, 75)) %>%
#   define_pop_state(n_z_population = runif(75)) %>%
#   make_ipm(
#     usr_funs = list(
#       predict_carp_ipm = predict_carp_ipm,
#       is_native        = is_native,
#       s_char           = s_char
#     ),
#     iterations = 75

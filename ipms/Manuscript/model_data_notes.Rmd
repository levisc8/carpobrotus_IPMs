...
- WorldClim cuts off at end of 2018

- CHELSA cuts off at end of 2019.
    
  + This is annoying, but I think I'll try to see what happens w/o January-March 2020. Then again, RNOAA may have weather station data to supplement these, except that we don't have this info for every site. SO the anomaly for these two sites across each month would have to be computed w/r/t some other data set that doesn't exactly match, entailing a whole bunch of other assumptions. 

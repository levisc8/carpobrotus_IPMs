  ...
  + Proposed Models:
    ...
    + Climate variables:
      ...
      + My instinct is to download weather data and use the following:
          ...
          + d. temp coldest month (or quarter, debating) (cool tolerance)
...
# Figure 1: Climate envelope of Carp spp. All figures include a range of GBIF occurrences in light colors, and our actual sites highlighted to illustrate range of sampling relative to actual global climate that they experience
# 
# Panel A: Mean ann temp ~ precip from Chelsa
# 
# Panel B: min temp ~ ann precip from Chelsa
# 
# Panel C: mean ann temp ~ precip from actual weather data for years before sampling (e.g. 2016-2018)
# 
# Panel D: min temp ~ ann precip from actual weather data for years before sampling (e.g. 2016-2018)
